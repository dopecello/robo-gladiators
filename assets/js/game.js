...
var startGame = function() {
  ...
  endGame(); //after loop ends, player is out of health and enemies, so run endGame func
};

var endGame = function() {
  window.alert("The game has now ended. Let's see how you did!");
  if (playerHealth > 0) {
    alert("Great job, you survived the game! You now have a score of " + playerMoney + ".");
  } 
  else {
